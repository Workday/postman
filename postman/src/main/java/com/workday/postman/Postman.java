...
/**
 * Entry point for classes wishing to use the Postman framework to handle the implementation details
 * of {@link Parcelable}. This service can handle Parcelable implementation details for all classes
 * either annotated with or containing fields annotated with {@literal @}{@link Parceled}.
 *
